...
const (
	// ScopeGlobal targets the global TUI config under the runtime root (for example ~/.config/seshat-tui/seshat.json).
	ScopeGlobal Scope = iota
	// ScopeWorkspace targets the workspace config (.seshat/seshat.json).
	ScopeWorkspace
)
