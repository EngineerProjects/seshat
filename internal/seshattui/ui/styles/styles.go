...
type Styles struct {
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "SESHAT" gradient
		LogoGradFromColor color.Color    // "SESHAT" wordmark gradient start
		LogoGradToColor   color.Color    // "SESHAT" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "Seshat" wordmark gradient start
		SmallGradToColor   color.Color    // Small "Seshat" wordmark gradient end
	}
	...
	Messages struct {
		...
		AssistantHeaderLabel lipgloss.Style // "◆ Seshat" bold label in assistant message header
