...
// All providers use the Seshat dark orange theme by default.
func ThemeForProvider(_ string) Styles {
	return SeshatDark()
}

// SeshatDark is the Seshat brand theme: orange/grey on a dark background.
func SeshatDark() Styles {
...
// HyperSeshatObsidiana returns the HyperSeshat dark theme.
func HyperSeshatObsidiana() Styles {
	return quickStyle(quickStyleOpts{
		primary:   charmtone.Charple,
		secondary: charmtone.Dolly,
		accent:    charmtone.Bok,
