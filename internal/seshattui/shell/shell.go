...
// SeshatEnvMarkers returns a fresh slice of the environment variables that
// Seshat unconditionally sets on every shell it spawns — both the interactive
...
func NewShell(opts *Options) *Shell {
	...
	env = append(env, SeshatEnvMarkers()...)
